...
def apply_rotary_pos_emb_flashatt(tensor: torch.Tensor, freqs: torch.Tensor) -> torch.Tensor:
    ...
    cos = freqs.cos()
    sin = freqs.sin()
    #!###### Editted by @tianchenggu #######
    # output = apply_rotary_emb(tensor_, cos, sin).type_as(tensor) #! Original
    output = apply_rotary_emb(tensor_.float(), cos.float(), sin.float()).type_as(tensor)
    #!###### Editted by @tianchenggu #######
    return output
...
class Qwen2_5_VisionTransformerPretrainedModel(Qwen2_5_VLPreTrainedModel):
    ...
    def rot_pos_emb(self, grid_thw):
        ...
        print(grid_thw)
        print("#"*50)
        # grid_thw = grid_thw.reshape(-1,3) #! edite by @tianchneg
