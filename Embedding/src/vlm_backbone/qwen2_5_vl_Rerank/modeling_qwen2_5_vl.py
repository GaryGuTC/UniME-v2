...
def apply_rotary_pos_emb_flashatt(
    ...
    q_embed = apply_rotary_emb(q.float(), cos.float(), sin.float()).type_as(q) # edit by @tiancheng
    k_embed = apply_rotary_emb(k.float(), cos.float(), sin.float()).type_as(k) # edit by @tiancheng
