...
from collators.MMEB_rerank import MMEBRerankDataCollator
from dataset.datasets_MMEB_rerank import LazySupervisedDataset
from loaders.qwen2_5_vl_raw import Qwen2_5VLModelLoader
...
def train():
    ...
    train_dataset = LazySupervisedDataset(
        ...
        image_path=data_args.dataset_name,
        tokenizer=tokenizer,
    )

    # data collator
    data_collator = MMEBRerankDataCollator(
        tokenizer=tokenizer,
        processor=processor,
    )
